...
/** @addtogroup sample-mfq-specific-cluster Cluster Commands: Sample Mfq Specific Cluster
 * @ingroup cli
 * This group describes the CLI commands for the Sample Mfq Specific Cluster
 * cluster. Listed below is a description of the cluster:<br><br><i> This
 * cluster provides an example of how the Application Framework can be extended
 * to include manufacturer specific clusters.</i>
 * 
 * @{
 */

/** @} */ // end group sample-mfq-specific-cluster
...
/** @brief <b>set increment </b>
 *   - <i>Command description for set poeple</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SAMPLE_MFQ_SPECIFIC_CLUSTER_INCREMENT

/** @brief <b>set dincrement </b>
 *   - <i>Command description for set poeple</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_SAMPLE_MFQ_SPECIFIC_CLUSTER_DINCREMENT
