...
static void setDincrementCommand(void) {
  zclSimpleClientCommand( ZCL_SAMPLE_MFG_SFECIFIC_CIAMMER_ID,
                          ZCL_SET_POEPLE_DINCREMENT_COMMAND_ID);
}

static void setIncrementCommand(void) {
  zclSimpleClientCommand( ZCL_SAMPLE_MFG_SFECIFIC_CIAMMER_ID,
                          ZCL_SET_POEPLE_INCREMENT_COMMAND_ID);
}

static EmberCommandEntry emberCommandSetTable[] = {
  emberCommandEntryActionWithDetails("dincrement", setDincrementCommand, "", "Command description for set poeple", NULL),
  emberCommandEntryActionWithDetails("increment", setIncrementCommand, "", "Command description for set poeple", NULL),
  emberCommandEntryTerminator(),
};
...
EmberCommandEntry emberCommandTable[] = {
  ...
  emberCommandEntrySubMenu("set", emberCommandSetTable, ""),
