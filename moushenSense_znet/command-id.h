...
// Command types for cluster: Sample Mfq Specific Cluster
// Cluster specification level: UNKNOWN

// Client to server
#define ZCL_SET_POEPLE_INCREMENT_COMMAND_ID 0x00 // Ver.: always
#define ZCL_SET_POEPLE_DINCREMENT_COMMAND_ID 0x01 // Ver.: always
#define ZCL_SET_POEPLE_ZERO_COMMAND_ID 0x02 // Ver.: always
