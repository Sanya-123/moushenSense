...
/** @name Sample Mfq Specific Cluster Commands */
// @{
/** @brief Command description for set poeple
 *
 * Cluster: Sample Mfq Specific Cluster, This cluster provides an example of how the Application Framework can be extended to include manufacturer specific clusters.
 * Command: setPoepleIncrement
 */
#define emberAfFillCommandSampleMfgSfecificCiammersetPoepleIncrement() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_SAMPLE_MFG_SFECIFIC_CIAMMER_ID, \
                            ZCL_SET_POEPLE_INCREMENT_COMMAND_ID, \
                            "");
 ...
 *
 * Cluster: Sample Mfq Specific Cluster, This cluster provides an example of how the Application Framework can be extended to include manufacturer specific clusters.
 * Command: setPoepleDincrement
 */
#define emberAfFillCommandSampleMfgSfecificCiammersetPoepleDincrement() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_SAMPLE_MFG_SFECIFIC_CIAMMER_ID, \
                            ZCL_SET_POEPLE_DINCREMENT_COMMAND_ID, \
                            "");
 ...
 *
 * Cluster: Sample Mfq Specific Cluster, This cluster provides an example of how the Application Framework can be extended to include manufacturer specific clusters.
 * Command: setPoepleZero
 */
#define emberAfFillCommandSampleMfgSfecificCiammersetPoepleZero() \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_SAMPLE_MFG_SFECIFIC_CIAMMER_ID, \
                            ZCL_SET_POEPLE_ZERO_COMMAND_ID, \
                            "");


/** @} END Sample Mfq Specific Cluster Commands */
