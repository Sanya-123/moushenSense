...
// Printing macros for cluster: Sample Mfq Specific Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER)
#define emberAfSampleMfgSfecificCiammerPrint(...) emberAfPrint(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER, __VA_ARGS__)
#define emberAfSampleMfgSfecificCiammerPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSampleMfgSfecificCiammerFlush()
#define emberAfSampleMfgSfecificCiammerDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER) ) { x; }
#define emberAfSampleMfgSfecificCiammerPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER, (buffer), (len), (withSpace))
#define emberAfSampleMfgSfecificCiammerPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER, (buffer))
#else
#define emberAfSampleMfgSfecificCiammerPrint(...)
#define emberAfSampleMfgSfecificCiammerPrintln(...)
#define emberAfSampleMfgSfecificCiammerFlush()
#define emberAfSampleMfgSfecificCiammerDebugExec(x)
#define emberAfSampleMfgSfecificCiammerPrintBuffer(buffer, len, withSpace)
#define emberAfSampleMfgSfecificCiammerPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SAMPLE_MFG_SFECIFIC_CIAMMER)
