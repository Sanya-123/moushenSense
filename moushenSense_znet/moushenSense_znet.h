...
#define EM_AF_GENERATED_NETWORK_STRINGS  \
  "Primary (pro)", \
/**** ZCL Section ****/
#define ZA_PROMPT "moushenSense_znet"
#define ZCL_USING_BASIC_CLUSTER_SERVER
#define ZCL_USING_IDENTIFY_CLUSTER_CLIENT
#define ZCL_USING_IDENTIFY_CLUSTER_SERVER
#define ZCL_USING_SAMPLE_MFG_SFECIFIC_CIAMMER_CLIENT
#define ZCL_USING_SAMPLE_MFG_SFECIFIC_CIAMMER_SERVER
/**** Optional Attributes ****/
...
#define ZCL_USING_SAMPLE_MFG_SFECIFIC_CIAMMER_PEOPLE_COUNTER_ATTRIBUTE 
...
#define EMBER_AF_SAMPLE_MFG_SFECIFIC_CIAMMER_CLIENT_ENDPOINT_COUNT (1)
#define EMBER_AF_SAMPLE_MFG_SFECIFIC_CIAMMER_SERVER_ENDPOINT_COUNT (1)
...
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_ZERO
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_INCREMENT
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_DINCREMENT
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_DINCREMENT
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_INCREMENT
#define EMBER_CALLBACK_SAMPLE_MFG_SFECIFIC_CIAMMER_SET_POEPLE_ZERO
...
#define EMBER_AF_API_ADC_CORTEXM3 "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc-cortexm3.h"

// API adc from ADC plugin
#define EMBER_AF_API_ADC "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/adc/adc.h"

// API antenna from Antenna Stub plugin
#define EMBER_AF_API_ANTENNA "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/antenna/antenna.h"

// API button-interface from Button Interface plugin
#define EMBER_AF_API_BUTTON_INTERFACE "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/button-interface/button-interface.h"

// API coexistence from Radio Coexistence Stub plugin
#define EMBER_AF_API_COEXISTENCE "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/radio/rail_lib/plugin/coexistence/protocol/ieee802154/coexistence-802154.h"

// API find-and-bind-target from Find and Bind Target plugin
#define EMBER_AF_API_FIND_AND_BIND_TARGET "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/find-and-bind-target/find-and-bind-target.h"

// API network-steering from Network Steering plugin
#define EMBER_AF_API_NETWORK_STEERING "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-steering/network-steering.h"

// API rail-library from RAIL Library plugin
#define EMBER_AF_API_RAIL_LIBRARY "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/radio/rail_lib/common/rail.h"

// API scan-dispatch from Scan Dispatch plugin
#define EMBER_AF_API_SCAN_DISPATCH "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/scan-dispatch/scan-dispatch.h"

// API serial from Serial plugin
#define EMBER_AF_API_SERIAL "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/plugin/serial/serial.h"

// API update-tc-link-key from Update TC Link Key plugin
#define EMBER_AF_API_UPDATE_TC_LINK_KEY "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/update-tc-link-key/update-tc-link-key.h"

// API command-interpreter2 from ZCL Framework Core plugin
#define EMBER_AF_API_COMMAND_INTERPRETER2 "../../../PO/simplicity_studio_5/developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/util/serial/command-interpreter2.h"
